      ...
      <ul class="nav nav-pills nav-justified">
         ...
         <li class = "dropdown">
            ...
            <ul class = "dropdown-menu">
               ...
               <li class="active"><a href = "DS.php">Nintendo DS</a></li>			
            </ul>
        </li>
