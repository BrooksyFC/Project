...
<body style="background-image: url(../Images/zelda.jpg)">
<div id="Main">
...
<div id="Content">
<img src="/Images/Majora'sMasklogo.jpg" width="320px" style="margin-left:200px;"></img>
<h3>Lastest Zelda: Majora's Mask News</h3>
<hr>
<h3><a href="../PriceSearch.php?value=zelda&search=Search">Click here</a> for the latest Zelda: Majora's Mask prices</h3>  
<hr>
<h3><a href="../Review.php">Click here</a> the Critic Reviews or <a href="../ReviewTopics.php?cid=6">here</a> to write your own user reviews</h3> 
<hr>
<h3>Latest Zelda: Majora's Mask Videos</h3>
<script type="text/javascript" src="http://ytchannelembed.com/ytce-frgallery.js"></script><div style="width:100%;max-width:780px;" class="ytce" data-user="Nintendo" data-rows="2" data-ratio="hd" data-width="250" data-margin="15" data-desc="100" data-desc_color="9E9E9E" data-title="30" data-title_color="000000" data-https="0" data-duration="1" data-views="1" data-likes="1" data-dislikes="1" data-fav="1" data-cols="3" ></div>
<h3>Latest Zelda: Majora's Mask Images</h3>         
<div class="row">
    <div class="col-md-4">
      <a href="../Images/zeldaimage1.jpg" class="thumbnail">  
        <img src="/Images/zeldaimage1.jpg" alt="Pulpit Rock" style="width:250px;height:150px">
      </a>
    </div>
    <div class="col-md-4">
      <a href="../Images/zeldaimage2.jpg" class="thumbnail">
        <img src="/Images/zeldaimage2.jpg" alt="Moustiers Sainte Marie" style="width:250px;height:150px">
      </a>
    </div>
    <div class="col-md-4">
      <a href="../Images/zeldaimage3.jpg" class="thumbnail">     
        <img src="/Images/zeldaimage3.jpg" alt="Cinque Terre" style="width:250px;height:150px">
      </a>
    </div>
</div> 
