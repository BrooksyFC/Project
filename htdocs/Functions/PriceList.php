...
foreach($html6->find('div.mt5 b.cost_p') as $element6)
  ...
  echo
	...
	<h3><a href='http://www.game.co.uk/en/fallout-4-637096?pageSize=40&searchTerm=fallout&catGroupId=' target='_blank'><img src='Images/Game-logo.jpg'> </img>".$element2->innertext()." </a></h3> <br>
	<h3><a href='http://www.videogamebox.co.uk/Fallout-4-PS4-p/20006983715476.htm' target='_blank'><img src='Images/videogamebox.png'> </img>".$element3->innertext()." </a></h3> 
	</th>
	
	<th width='620'>
	<br>
	<h3><a href='http://www.rakuten.co.uk/shop/gameseek/product/VideoGamesjm1wfcmvu8/?l-id=gb_search_grid_product_thumbnail_2' target='_blank'><img src='Images/rakuten.jpg'> </img>".$element4->innertext()."</a></h3><br> <br>
	<h3><a href='http://www.zavvi.com/games-ps4/fallout-4/11123669.html?widget_id=88166' target='_blank'><img src='Images/zavvi_logo.png'> </img>".$element5->innertext()." </a></h3> <br>
	<h3><a href='http://www.gameseek.co.uk/pd/VideoGamesjm1wfcmvu8/Fallout-4' target='_blank'><img src='Images/gameseek.jpg'> </img>".$element6->innertext()." </a></h3> 
	</th>
