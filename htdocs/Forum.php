...
<div id="Content"><h2>Forum</h2><h3>Categories</h3>
<?php
...
if (mysql_num_rows($result) > 0) {
	while ($row = mysql_fetch_assoc($result)) {
		...
		$categories .= "<a href='Topics.php?cid=".$id."' class='topics'><font size='4'>".$title."</font><br><font size='2'> ".$description."</font></a>";
	}
	echo $categories;
} else {
	echo "There are no topics in the forum yet";
}
?>
</div>
</div>
