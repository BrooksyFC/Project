...
<div id="Content"><h2>Review Details</h2><br><h5>Please enter the review details below</h5>
<hr>
<form action="Functions/CreateReview.php" method="post">
<p>Review Title</p>
<input type="text" name="review_title" size="70" maxlength="150" >
<p>Details</p>
<textarea name="review_content" rows="5" cols="70"></textarea>
<br><br>
<input type="hidden" name="cid" value="<?php echo $cid; ?>">
<input type="submit" name="review_submit" value="Create New Review"> 
</form>
</div>
</div>
</div>
