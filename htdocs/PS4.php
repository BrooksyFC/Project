      ...
      <ul class="nav nav-pills nav-justified">
         ...
         <li class = "dropdown">
            ...
            <ul class = "dropdown-menu">
               ...
               <li class="active"><a href = "PS4.php">PlayStation 4</a></li>
