...
<div id="Content"><h2>Topic Details</h2><br>
<form action="Functions/CreateTopic.php" method="post">
<div class="panel panel-default">
 <div class="panel-heading">
  <h3 class="panel-title">Please enter the required details bellow</h3>
 </div>
  <div class="panel-body">

<div style="margin-bottom: 25px" class="input-group">
    <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
    <input type="text" class="form-control" name="topic_title" placeholder="Please enter a Topic Title">                                        
</div>

<div style="margin-bottom: 25px" class="input-group">
    <span class="input-group-addon"><span class="glyphicon glyphicon-pencil"></span></span>
	<textarea name="topic_content" rows="5" cols="70" placeholder="Please enter the Topix Details"></textarea>
</div>

<input type="hidden" name="cid" value="<?php echo $cid; ?>" class="btn btn-info btn-block">
<input type="submit" name="topic_submit" value="Create New Topic" class="btn btn-info btn-block">
  </div>
</div>
