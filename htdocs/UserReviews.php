...
$query = "SELECT * FROM games ORDER BY game_title ASC"; //Select usernames from database
...
if (mysql_num_rows($result) > 0) {
	while ($row = mysql_fetch_assoc($result)) {
		...
		$categories .= "<a href='ReviewTopics.php?cid=".$id."' class='topics'><font size='4'>".$title."</font><br><font size='2'> ".$description."</font></a>";
	}
	echo $categories;
} else {
	echo "There are no reviews in the forum yet";
}
?>
</div>
</div> 
